...
export const projects: Project[] = [
  ...
  },
  {
    ...
    decisions: [],
    outcome:
      'A four-touchpoint concept campaign (billboard, bus wrap, transit shelter, and social), one idea carried in one voice across every context, built to demonstrate campaign and copy thinking, not a delivered Bumble asset.',
