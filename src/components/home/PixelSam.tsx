    ...
    >
      ...
      >
        ...
        >
          <img
            src={pixelSam}
            alt="Pixel-art illustration of Samantha, wearing an 'I heart PM' shirt, aiming a purple-and-green paint blaster with a speech bubble reading 'Design. Iterate. Repeat.'"
            width={700}
            height={700}
