  ...
  return (
    <section className="px-6 py-8 sm:px-10 sm:py-12">
      <div className="mx-auto max-w-6xl">
        <SectionHeading kicker="The challenge" title="Three barriers, one root cause." className="mb-10 max-w-2xl" />
              ...
              <Reveal key={item.number} delay={index * 0.08}>
                ...
                >
                  ...
                  <Icon
                    size={56}
                    strokeWidth={1.25}
                    className="hidden shrink-0 text-fg-muted/15 transition-colors duration-300 group-hover:text-mint/40 sm:block"
                  />
                </motion.div>
              </Reveal>
            )
